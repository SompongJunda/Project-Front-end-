...
export class CallserviceService {
  ...
  saveRegister(data: any): Observable<any> {
    ...
    return this.http.post<any>(
      API_ENDPOINT.concat('/register/save'),
      body,
      httpOptions
    );
  }
  ...
  getByUserId(userId: any): Observable<any> {
    return this.http.get(
      API_ENDPOINT.concat('/register/getById?userId=' + userId)
    );
  }
  ...
  deleteUserByUserId(userId: any): Observable<any> {
    return this.http.delete(
      API_ENDPOINT.concat('/register/delete?userId=' + userId)
    );
  }
  ...
  saveProduct(data: any): Observable<any> {
    const body = JSON.stringify(data);
    return this.http.post<any>(
      API_ENDPOINT.concat('/product/save'),
      body,
      httpOptions
    );
  }
  ...
  saveProfileImgUserId(formData: FormData, userId: any): Observable<any> {
    return this.http.post<any>(
      API_ENDPOINT.concat('/manage/user/saveImage/' + userId),
      formData
    );
  }
  ...
  deleteProfileImage(fileName: any): Observable<any> {
    return this.http.delete(
      API_ENDPOINT.concat(
        '/manage/user/deleteImgByFileName?fileName=' + fileName
      )
    );
  }
  // removeImgByProductId(productId : any) : Observable<any> {
  ...
  getProfileImgByUserId(userId: any): Observable<any> {
    return this.http.get(
      API_ENDPOINT.concat('/manage/user/getProfileImgByUserId?userId=' + userId)
    );
  }
  ...
  getProfileImgBlobThumbnail(fileName: string): Observable<Blob> {
    ...
    return this.http.get<Blob>(
      API_ENDPOINT.concat('/manage/user/getImageByte?fileName=' + fileName),
      { headers: headers, responseType: 'blob' as 'json' }
    );
  }
  ...
  updateProfile(data: any, userId: any): Observable<any> {
    const body = JSON.stringify(data);
    return this.http.put<any>(
      API_ENDPOINT.concat('/register/update/' + userId),
      body,
      httpOptions
    );
  }
